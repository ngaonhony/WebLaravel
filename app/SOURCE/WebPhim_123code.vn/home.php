        ...
        <div class="blockbody" id="list-movie-update">
          ...
          ?>
                    <li data-liked="852" data-views="49,875">
                        <div class="inner"><a href="?mod=detail&film_id=<?php echo $r['id'] ?>"
                                title="<?php echo $r['name'] ?>"><img src="<?php echo $r['image'] ?>"
                                    alt="Nhật Ký Trả Thù 2"></a>
                            <div class="info">
                                <div class="name"><a href="?mod=detail&film_id=<?php echo $r['id'] ?>"
                                        title="<?php echo $r['name'] ?>"><?php echo $r['name'] ?></a></div>
          ...
          ?>
                    <li data-liked="3,987" data-views="94,650">
                        <div class="inner"><a href="?mod=detail&film_id=<?php echo $r['id'] ?>"
                                title="<?php echo $r['name'] ?>"><img src="<?php echo $r['image'] ?>" alt=""></a>
                            <div class="info">
                                <div class="name"><a href="?mod=detail&film_id=<?php echo $r['id'] ?>"
                                        title="<?php echo $r['name'] ?>"><?php echo $r['name'] ?></a></div>
                                <div class="name2"><?php echo $r['name2'] ?></div>
