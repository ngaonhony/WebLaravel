                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="status" class="form-control" placeholder="nhập trạng thái phim">
                        </div>
                        <div class="form-group">
                            <strong> Đạo diễn</strong>
                            <input type="text" name="director" class="form-control" placeholder="nhập Đạo diễn">
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
