      ...
      <div class="row container" id="wrapper">
         <div class="halim-panel-filter">
            <div class="panel-heading">
               <div class="row">
                  <div class="col-xs-6">
                     <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim hay</a> » <span><a href="danhmuc.php">{{$phim->category->name}}</a> » <span class="breadcrumb_last" aria-current="page">{{$phim->name}}</span></span></span></span></div>
                  </div>
               </div>
            </div>
